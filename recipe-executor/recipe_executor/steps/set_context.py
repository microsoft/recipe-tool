...
def _has_unrendered_tags(text: str) -> bool:
    """
    Detect if the string still contains Liquid tags that need rendering.
    Does not consider content within {% raw %}...{% endraw %} blocks.
    """
...
class SetContextStep(BaseStep[SetContextConfig]):
    ...
    def __init__(self, logger: logging.Logger, config: Dict[str, Any]) -> None:
        # Validate and store config using Pydantic
    ...
    async def execute(self, context: ContextProtocol) -> None:
        ...
        # Render the provided value (string, list, dict) with nested option
    ...
    def _render_value(self, raw: Any, context: ContextProtocol, nested: bool) -> Any:
        ...
        # Other JSON-serialisable types: return as-is
        return raw

    def _merge(self, old: Any, new: Any) -> Any:
        """
        Shallow merge helper for combining existing and new values.
