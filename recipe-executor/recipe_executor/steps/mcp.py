...
class MCPStep(BaseStep[MCPConfig]):  # type: ignore
    ...
    def __init__(self, logger: logging.Logger, config: Dict[str, Any]) -> None:
        """
        Initialize MCPStep with validated configuration.
        """
    ...
    async def execute(self, context: ContextProtocol) -> None:
        """
        Execute the step: render templates, connect to MCP, call tool, and store result.
        """
        # Render tool name
        ...
        # Determine transport: stdio if 'command' in server_conf, else SSE
            ...
            if server_conf.get("env") is not None:
                ...
                for env_k, env_v in server_conf.get("env", {}).items():
                    if isinstance(env_v, str):
                        ...
                        if rendered == "":
                            # Attempt to load from .env or system
