...
def json_object_to_pydantic_model(schema: Dict[str, Any], model_name: str = "SchemaModel") -> Type[BaseModel]:
    ...
    Args:
        schema: A JSON-Schema fragment describing an object (root type must be "object").
        model_name: Name to assign to the generated Pydantic model class.
    ...
    # Counter for deterministic nested model naming
    class _Counter:
    ...
    def _build_model(obj_schema: Dict[str, Any], name: str) -> Type[BaseModel]:
        ...
        for prop_name, subschema in props.items():
            ...
            hint, default = _wrap_optional(subschema, is_req, prop_name, name)
