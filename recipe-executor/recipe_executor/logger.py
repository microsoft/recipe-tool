...
Provides initialization for application-wide logging. Writes logs to separate files for debug, info, and error levels, as well as to stdout.
"""
...
def init_logger(log_dir: str = "logs", stdio_log_level: str = "INFO") -> logging.Logger:
    ...
    """
    # Get root logger and set to lowest to capture all levels
    ...
    # Initialization logs
    logger.debug("Initializing logger: log_dir='%s', stdio_log_level='%s'", log_dir, level_name)
