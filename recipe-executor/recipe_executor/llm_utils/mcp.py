...
def get_mcp_server(logger: logging.Logger, config: Dict[str, Any]) -> MCPServer:
    ...
    if "url" in config:
        ...
        try:
            # Instantiate HTTP server, only pass headers or tool_prefix if given
    ...
    if "command" in config:
        ...
        if env_cfg is not None:
            ...
            # If any value blank and load_dotenv available, load .env
        ...
        try:
            # Instantiate Stdio server with necessary args
