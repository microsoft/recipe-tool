...
def get_azure_openai_model(
    ...
    # Log loaded config (mask sensitive values)
    masked_key = _mask_secret(os.getenv("AZURE_OPENAI_API_KEY"))
    logger.debug(
        f"Azure OpenAI config: endpoint={azure_endpoint}, "
        f"api_version={azure_api_version}, deployment={deployment}, "
        f"use_managed_identity={use_managed_identity}, "
