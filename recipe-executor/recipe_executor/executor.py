...
class Executor(ExecutorProtocol):
    ...
    async def execute(
        ...
        """
        # Determine and load the recipe model
        if isinstance(recipe, Recipe):
            ...
            # String input (file path or raw JSON)
        ...
        try:
            ...
            summary = {}
        steps = getattr(recipe_model, "steps", [])
        self.logger.debug(f"Recipe loaded: {summary}. Steps count: {len(steps)}")

        # Execute each step in sequence
        for idx, step in enumerate(steps):  # type: ignore
            step_type = step.type
            ...
            try:
                ...
                raise ValueError(f"Error executing step {idx} ('{step_type}'): {e}") from e
